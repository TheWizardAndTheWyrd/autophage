...
A prototype of a distributed communication platform/social network.

This prototype is built on the ChicagoBoss framework with the Erlang system.

After downloading/cloning, rung the following commands to get a local server running:
